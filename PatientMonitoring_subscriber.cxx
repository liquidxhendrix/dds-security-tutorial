...
unsigned int process_data(PatientMonitoringDataReader *typed_reader)
{
    PatientMonitoringSeq data_seq;     // Sequence of received data
    ...
    for (int i = 0; i < data_seq.length(); ++i) {
        ...
        if (info_seq[i].valid_data) {
            ...
            PatientMonitoringTypeSupport::print_data(&data_seq[i]);
            samples_read++;
...
int run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    // This DataReader reads data on "Example PatientMonitoring" Topic
    ...
    PatientMonitoringDataReader *typed_reader =
    PatientMonitoringDataReader::narrow(untyped_reader);
