...
#include "PatientMonitoringSupport.h"
...
int run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    const char *type_name = PatientMonitoringTypeSupport::get_type_name();
    DDS_ReturnCode_t retcode =
    PatientMonitoringTypeSupport::register_type(participant, type_name);
    ...
    // This DataWriter writes data on "Example PatientMonitoring" Topic
    ...
    PatientMonitoringDataWriter *typed_writer =
    PatientMonitoringDataWriter::narrow(untyped_writer);
    ...
    PatientMonitoring *data = PatientMonitoringTypeSupport::create_data();
    if (data == NULL) {
        return shutdown_participant(
            participant,
            "PatientMonitoringTypeSupport::create_data error",
            EXIT_FAILURE);
    }
    ...
    ++samples_written) {
        ...
        std::cout << "Writing PatientMonitoring, count " << samples_written 
        << std::endl;
    ...
    // Delete previously allocated PatientMonitoring, including all contained elements
    retcode = PatientMonitoringTypeSupport::delete_data(data);
    if (retcode != DDS_RETCODE_OK) {
        std::cerr << "PatientMonitoringTypeSupport::delete_data error " << retcode
        << std::endl;
    }
